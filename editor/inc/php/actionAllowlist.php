...
oasysRegisterActionAllowlists([
    ...
    'editor/systemSettingActions.php' => [
        'm_status', 'change_m_status', 'file_cleanup', 'filesyscheck', 'syscheck', 'mediaCheck', 'mediaCheckSafety', 'mediaRepair',
    ...
    'editor/dashboard/systemstatus/systemstatus.php' => [
        ...
        'syscheckDetails', 'showDbDetails', 'runDbIntegrityCheck', 'runMediaIntegrityCheck',
    ],
