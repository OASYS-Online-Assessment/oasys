    ...
    tuneText = function (el, params) {
        ...
        if (params[has]("text")) {
            ...
            for (var i = 0, ii = texts.length; i < ii; i++) {
                ...
                tspans[i] = tspan;
                //console.log('params ha text tspan created with '+texts[i])
            }
        } else {
            //console.log('params has not text, collecting tspans')
            tspans = node.getElementsByTagName("tspan");
            for (i = 0, ii = tspans.length; i < ii; i++) if (i) {
                //console.log('tspan != 0 dy - fontSize: '+fontSize+' * leading: '+leading)
                $(tspans[i], {dy: fontSize * leading, x: a.x});
            } else {
                //console.log('tspan != 0 dy set to 0')
                $(tspans[0], {dy: 0});
            }
        }
        $(node, {x: a.x, y: a.y});
        ...
        var bb = el._getBBox(),
            ...
            //console.log('dif is calculated as '+dif)
